...
function generate_and_apply_sealed_secret() {
  echo "🔑 Creating raw Kubernetes secret for DB credentials..."
...
EOF
  ...
  echo "💾 Saving DB credentials to db-password.txt (DO NOT COMMIT)..."
...
echo "🔏 Generating and applying sealed secret..."
